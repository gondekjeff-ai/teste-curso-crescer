...
const WorkwearProject = () => {
  return (
    ...
    >
      <SEO
        title="Workwear Climate Control — Estudo de caso"
        description="Vestuário inteligente com regulação térmica para ambientes de trabalho extremos. Caso de R&D em sensores integrados."
        type="article"
      />
