...
const HockeyProject = () => {
  return (
    ...
    >
      <SEO
        title="Ice Hockey Elite Skill Tracker — Estudo de caso"
        description="Análise avançada de movimento para hóquei no gelo: sensores integrados que geram métricas reais para treinamento de elite."
        type="article"
      />
