...
const PetProject = () => {
  return (
    ...
    >
      <SEO
        title="Dog Activity Counter — Estudo de caso"
        description="Monitoramento inteligente da atividade canina para saúde e seguros: sensores conectados a dados acionáveis."
        type="article"
      />
